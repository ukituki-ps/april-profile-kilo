...
- [x] Конфликтный UI доступен в Hub под корректной ролью.
- [x] Проверены позитивный и негативный RBAC-кейсы.
- [x] E2E/smoke сценарий разрешения конфликта стабилен.
...
- [x] Создана/обновлена страница `docs-site/docs/task-story-032-phase-4a-hub-conflicts-merge-host-rbac.md` с пометкой "исполнение в AprilHub".
- [x] В [`docs-site/docs/task-stories-overview.md`](../../docs-site/docs/task-stories-overview.md) добавлена ссылка и обновлен статус.
- [x] Простым языком описано, как в Hub проходит разрешение конфликтов.
- [x] Отдельно описаны роли и риски при неправильной настройке доступа.
- [x] В конце страницы есть ссылки на `tasks/032-phase-4a-hub-conflicts-merge-host-rbac/TASK.md`, `PLAN.md` (если появится), `REPORT.md`.
