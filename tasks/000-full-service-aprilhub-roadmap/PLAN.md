...
**Зависимости:** фаза 4.2 завершена (контур интеграции стабилен), фаза 2 реализована минимум до API для CRUD/versions/conflicts; координация с AprilHub по маршрутам и e2e — ручная контрольная точка.
...
6. После стабилизации базового UI-контура выполнить 4a (продуктовые виджеты: profiles list, instances, history, conflicts) как отдельные инкременты.
