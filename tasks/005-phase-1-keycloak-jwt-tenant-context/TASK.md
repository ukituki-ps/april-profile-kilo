...
- [x] (опционально, стенд с Hub) Выполнен или запланирован smoke: общий OIDC-логин → API с `Authorization: Bearer` — успех; при возможности — без повторного ввода пароля при активной SSO-сессии Keycloak.
