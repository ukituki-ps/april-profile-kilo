...
**Не входило:** полноценные клиентские интеграции с AprilOrgFlow/EDC (фаза 5), дашборды/алерты Grafana. Политика DLQ/ретраев для фона — [задача 017](./task-story-017-async-retries-dlq).
