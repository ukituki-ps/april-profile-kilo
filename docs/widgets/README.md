...
|-------------|----------|---------|
| `entity-profile` | Домен профилей сущностей в AprilProfile | [`profiles-widget`](./profile/profiles-widget.md) (сборка: список + детальная карточка), [`profiles-widget-profile-detail`](./profile/profiles-widget-profile-detail.md) (npm: карточка + создание) |
